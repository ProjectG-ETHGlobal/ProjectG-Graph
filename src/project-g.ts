import {
  AddUser as AddUserEvent,
  Approval as ApprovalEvent,
  ApprovalForAll as ApprovalForAllEvent,
  OrderCancelled as OrderCancelledEvent,
  OrderCreated as OrderCreatedEvent,
  OrderStatusMessage as OrderStatusMessageEvent,
...
export function handleOrderStatusMessage(event: OrderStatusMessageEvent): void {
  let entity = new OrderStatusMessage(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.orderId = event.params.orderId
  entity.statusMessage = event.params.statusMessage
